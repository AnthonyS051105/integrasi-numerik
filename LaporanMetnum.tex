...
\begin{itemize}
    \item \textbf{f}: fungsi yang akan diintegralkan, yaitu fungsi 1: $f(x) = \cos(x)$ dan fungsi 2: $f(x) = x^2$
    \item \textbf{a}: batas bawah, yaitu 0 untuk fungsi 1 dan fungsi 2
    \item \textbf{b}: batas atas, yaitu $\frac{\pi}{2}$ untuk fungsi 1 dan 1 untuk fungsi 2
